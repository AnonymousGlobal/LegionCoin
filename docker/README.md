...
official/supported Docker Images found at https://hub.docker.com/r/legioncoinpay/legioncoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/legioncoinpay/legioncoind-develop/ when changing the above text**