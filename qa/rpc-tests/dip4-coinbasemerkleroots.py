...
from test_framework.test_framework import LegionCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(LegionCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as LegionCoinTestFramework doesn't support this atm)
