...
// Copyright (c) 2020 The LegionCoin Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1592512809, nBits=1e0ffff0, nNonce=858244, vtx=1)
...
{
    const char* pszTimestamp = "We Are Legion  We Do Not Forgive  We Do Not Forget  Expect Us";
    const CScript genesisOutputScript = CScript() << ParseHex("0405eaa276ab72c3add2f8b78674dc1379a746e39900832a8efa224d1b54005dabd35a050cc4a3d57f74653aa0c116e3a64407915bc85b8908ca3669e52b459de0") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000341d95ec58316f264b8a9b0ec3fb99b3325cbc87085034667d03cb253dc"); 
        ...
        vAlertPubKey = ParseHex("04ac4778ab3e31ebc37bcf83ac66cffd74288453f46814b926ff7d715c1cc3ee4aa56689b16f5362db70a22f5245e24e703da91f11fa6b9af1e56a51f5e9d4d1bb");
        nDefaultPort = 20468;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1592512809, 858244, 0x1e0ffff0, 1, 10 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000341d95ec58316f264b8a9b0ec3fb99b3325cbc87085034667d03cb253dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x70526fcb42b148334bb4bd4c0ff7ce62c2d3ddf9a4488a1dea8eb73fe9d2caf7"));
        ...
        // LegionCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // LegionCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // LegionCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"LbUYjUMteRJxVz6aPDu3MuugSuMF53FoZK"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000341d95ec58316f264b8a9b0ec3fb99b3325cbc87085034667d03cb253dc"))
        };

        chainTxData = ChainTxData{
            1592512809, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000005157c4ba76d70a8365d9ce1015b067b955c3d2252d5cf9f3060a927211f"); 

        pchMessageStart[0] = 0xb9;
        pchMessageStart[1] = 0xe9;
        pchMessageStart[2] = 0x4b;
        pchMessageStart[3] = 0x4c;
        vAlertPubKey = ParseHex("04ba38dda079ddd04ca3c5308302d23f35c5a81b3d6aa974dfe35c279cd148e855849e3b3f4c801164645ab693352f33896155382545b44485e6417de8ebfe4664");
        nDefaultPort = 30468;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1592512814UL, 330268UL, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000005157c4ba76d70a8365d9ce1015b067b955c3d2252d5cf9f3060a927211f"));
        assert(genesis.hashMerkleRoot == uint256S("0x70526fcb42b148334bb4bd4c0ff7ce62c2d3ddf9a4488a1dea8eb73fe9d2caf7"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // Testnet LegionCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet LegionCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet LegionCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"LLmLemkvUXXc9wthn7DKN21RXHK9UpKeLL"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000005157c4ba76d70a8365d9ce1015b067b955c3d2252d5cf9f3060a927211f"))
        };

        chainTxData = ChainTxData{
            1592512814, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1592512819, 2, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x64f0d9ae5b0640b04ba798d57322b29a71117fcdd4bd2ff5b8c80167c3f979ee"));
        assert(genesis.hashMerkleRoot == uint256S("0x70526fcb42b148334bb4bd4c0ff7ce62c2d3ddf9a4488a1dea8eb73fe9d2caf7"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("legioncoinevo.org",  "devnet-seed.legioncoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x64f0d9ae5b0640b04ba798d57322b29a71117fcdd4bd2ff5b8c80167c3f979ee"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6vBFYBhTHr6uP93U8tNpguYccaxhoF2han2yRDo2c3613yA9Nba
        vSporkAddresses = {"Lb5HJebVgfwZJAFdWFq7xN4izejTTEfEwq"};
        nMinSporkKeys = 1;
        ...
        // Regtest LegionCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        // Regtest LegionCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,49);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // Regtest LegionCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest LegionCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest LegionCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
