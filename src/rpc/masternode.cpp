...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner LegionCoin address\n"
            "  payee          - Print the masternode payout LegionCoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting LegionCoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "legioncoin",               "masternode",             &masternode,             true,  {} },
    { "legioncoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "legioncoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "legioncoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
