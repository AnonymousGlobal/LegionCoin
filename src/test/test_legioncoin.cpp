...
#define BOOST_TEST_MODULE LegionCoin Test Suite

#include "test_legioncoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_legioncoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
