...
This mechanism has been integrated into Bitcore-Node-LegionCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/legioncoinpay/insight-api-legioncoin#web-socket-api](https://github.com/legioncoinpay/insight-api-legioncoin#web-socket-api)
* API: [https://github.com/legioncoinpay/insight-api-legioncoin#instantsend-transactions](https://github.com/legioncoinpay/insight-api-legioncoin#instantsend-transactions)
