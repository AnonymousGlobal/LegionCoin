...
EXPECTED_HOLDER_NAMES = [
    ...
    "The LegionCoin Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a LegionCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The LegionCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of LegionCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the LegionCoin Core repository.
"""
